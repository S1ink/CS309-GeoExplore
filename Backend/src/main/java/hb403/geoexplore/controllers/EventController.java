...
public class EventController {
	...
	public @ResponseBody List<EventEntity.JsonFormat> getReportsWithinBounds(@RequestBody String wkt_bounds_geom) {	// takes in 'well known text' for the bounding geometry --> may define special json formats for predefined bounds later
		try {
